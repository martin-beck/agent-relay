...
| `:provider:*` | Codex, OpenCode, OpenDesk, Continue, Claude, Cline, Aider, and not-yet-app-exposed WorkBuddy adapters plus the fail-closed OpenJiuwen metadata probe |
